...
/*                 THIS IS DEVANSH DALAL.
 * 				   I DECLARE THAT THIS ALGORITHM IS NOT IMPLEMENTED BY ME.
 * 				   I GOT THIS FROM PASTEBIN.COM WRITTEN BY Felipe Lopes de Freitas.
